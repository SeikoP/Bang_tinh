...
class IProductRepository(ABC):
    ...
    @abstractmethod
    def add(self, name: str, large_unit: str, conversion: int, unit_price: float) -> int:
        """Add new product, returns ID"""
        pass
    
    @abstractmethod
    def update(self, product_id: int, name: str, large_unit: str, 
...
class IHistoryRepository(ABC):
    ...
    @abstractmethod
    def get_by_date_range(self, start_date: date, end_date: date) -> List['SessionHistory']:
