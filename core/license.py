...
-----END PUBLIC KEY-----"""
    ...
    def validate(self, license_key: str) -> Tuple[bool, Dict[str, Any]]:
        ...
        try:
            ...
            self.logger.info(f"License validated successfully for {license_data.get('customer')}")
...
class LicenseManager:
    ...
    def validate_startup_license(self, license_key: Optional[str], environment: str) -> bool:
        """
