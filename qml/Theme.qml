...
QtObject {
    ...
    readonly property color onPrimaryContainer: "#064e3b"   // Emerald-900
    readonly property color onSecondary: "#FFFFFF"
    readonly property color onBackground: "#1F2937"         // Gray-800
    readonly property color onSurface: "#1F2937"            // Gray-800
    readonly property color onSurfaceVariant: "#6B7280"     // Gray-500
