...
class CalculatorService:
    ...
    def parse_to_small_units(self, value_str: str, conversion: int) -> int:
        ...
        try:
            ...
            raise ValidationError(f"Invalid numeric format: {value_str}", "value_str") from e
    ...
    def calculate_used(self, handover: int, closing: int) -> int:
        ...
        if closing > handover:
            raise ValidationError("Closing quantity cannot exceed handover quantity", "closing")
