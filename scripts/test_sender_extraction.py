...
test_cases = [
    # Vietinbank format
    (
        "TK 1234567890 GD +3,000,000 VND luc 20:15 05/02. SD 18,000,000 VND. ND Chuyen tien tu NGUYEN VAN A",
        "NGUYEN VAN A",
    ),
    (
        "TK 9876543210 +2,500,000 VND vao 14:30. ND Nhan tien tu TRAN THI B. Ref VTB.123456",
        "TRAN THI B",
    ),
    (
        "Vietinbank: TK 1111222233 +1,500,000 VND vao 10:00. ND Chuyen tien tu LE VAN C",
        "LE VAN C",
    ),
    (
        "VTB: TK 4444555566 +800,000 VND. ND Nhan tien tu PHAM THI D. Ref VTB.789012",
        "PHAM THI D",
    ),
    ...
    (
        "Techcombank TK 7777888899 +3,500,000 VND. ND Nhan tien tu NGUYEN THI F. Ref TCB.345678",
        "NGUYEN THI F",
    ),
    ...
    (
        "MBBank +1,800,000 VND vao 16:45. ND Nhan tien tu BUI THI H. Ref MBVCB.901234",
        "BUI THI H",
    ),
    ("MB: +3,200,000d. ND Nhan tien tu PHAM VAN LONG. MBVCB.123456", "PHAM VAN LONG"),
    (
        "MBBank: TK 987654321 +1,500,000 VND. ND: HOANG THI LAN chuyen tien",
        "HOANG THI LAN",
    ),
    # ACB format
    ("ACB: +2,200,000 VND. ND Chuyen tien tu DANG VAN I", "DANG VAN I"),
    (
        "ACB TK 9999000011 +1,600,000 VND. ND Nhan tien tu VO THI K. Ref ACB.567890",
        "VO THI K",
    ),
    ...
    (
        "TP: TK 2222333344 +1,100,000 VND. ND Nhan tien tu PHAN THI M. Ref TP.123456",
        "PHAN THI M",
    ),
    ...
    (
        "BIDV TK 123123123 +1,700,000d. ND: Nhan tien tu HOANG THI LINH",
        "HOANG THI LINH",
    ),
    # Agribank format
    ...
    # Long names (4 words)
    (
        "TK 1111222233 +1,300,000 VND. ND Chuyen tien tu NGUYEN HOANG MINH ANH",
        "NGUYEN HOANG MINH ANH",
    ),
    (
        "TK 4444555566 +1,700,000 VND. ND Nhan tien tu TRAN THI THANH THUY",
        "TRAN THI THANH THUY",
    ),
    # With Ref/MBVCB/FT at the end
    (
        "TK 7777888899 +2,100,000 VND. ND Chuyen tien tu LE VAN NAM. Ref MBVCB.123456",
        "LE VAN NAM",
    ),
    (
        "TK 1234567890 +1,400,000 VND. ND Nhan tien tu PHAM THI LAN. Ref FT12345678",
        "PHAM THI LAN",
    ),
    (
        "TK 9999888877 +3,600,000 VND. ND: NGUYEN VAN HAI. MBVCB.789012",
        "NGUYEN VAN HAI",
    ),
