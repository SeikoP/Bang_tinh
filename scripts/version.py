...
class CommitAnalyzer:
    ...
    def analyze_commits(self, commits: List[str]) -> Dict[str, List[str]]:
        ...
        for commit in commits:
            ...
            if self.COMMIT_PATTERNS['breaking'].search(body) or \
               self.COMMIT_PATTERNS['breaking'].search(subject):
...
class ChangelogGenerator:
    ...
    def generate_entry(self, version: Version, categorized: Dict[str, List[str]]) -> str:
