...
class InputValidator:
    ...
    @staticmethod
    def validate_numeric(value: Any, field_name: str = "input", 
    ...
    @staticmethod
    def validate_integer(value: Any, field_name: str = "input",
...
class SQLSafeQuery:
    ...
    def build_select(table: str, columns: List[str] = None,
                    where_clause: str = None, params: tuple = None) -> tuple:
        """
    ...
    @staticmethod
    def build_update(table: str, set_clause: str, where_clause: str,
                    params: tuple) -> tuple:
        """
